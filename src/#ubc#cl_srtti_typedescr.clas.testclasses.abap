...
CLASS ltc_main DEFINITION
  ...
  PRIVATE SECTION.
    ...
    METHODS assert_attribute_values
      IMPORTING
        srtti type ref to /ubc/cl_srtti_typedescr
...
CLASS ltc_main IMPLEMENTATION.
  ...
  METHOD create_by_rtti_elem.
    ...
    DATA(srtti) = /ubc/cl_srtti_typedescr=>create_by_data_object( variable ).
  ...
  METHOD create_by_rtti_class.
    ...
    variable = NEW #( ).
    DATA(srtti) = /ubc/cl_srtti_typedescr=>create_by_rtti( CAST #( cl_abap_typedescr=>describe_by_object_ref( variable ) ) ).
  ...
  METHOD create_by_rtti_intf.
    ...
    DATA(srtti) = /ubc/cl_srtti_typedescr=>create_by_rtti( rtti_intf ).
  ...
  METHOD serialize_deserialize.
    ...
    DATA(srtti) = NEW /ubc/cl_srtti_typedescr( cl_abap_typedescr=>describe_by_data_ref( dref ) ).
* absolute_name
* type_kind
* length
* decimals
...
*    variable = 'Hello world'.
  ...
  METHOD technical_type.
    ...
    DATA(srtti) = /ubc/cl_srtti_typedescr=>create_by_data_object( dobj_with_bound_data_type ).
