...
CLASS /ubc/cl_srtti_structdescr DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      BEGIN OF sabap_componentdescr,
        name       TYPE string,
        type       TYPE REF TO /ubc/cl_srtti_datadescr,
...
CLASS /ubc/cl_srtti_structdescr IMPLEMENTATION.
  ...
  METHOD constructor.
    ...
    LOOP AT rtti->get_components( ) ASSIGNING FIELD-SYMBOL(<component>).
      DATA(scomponent) = VALUE sabap_componentdescr(
          name       = <component>-name
          type       = CAST #( /ubc/cl_srtti_datadescr=>create_by_rtti( <component>-type ) )
