CLASS /ubc/cl_srtti_aunit DEFINITION
  PUBLIC
  FOR TESTING
  FINAL
  CREATE PUBLIC .
...
CLASS /ubc/cl_srtti_aunit IMPLEMENTATION.
  ...
  METHOD serialize_deserialize.
    ...
    DATA(srtti1) = /ubc/cl_srtti_typedescr=>create_by_data_object( <variable1> ).
    ...
    DATA srtti2 TYPE REF TO /ubc/cl_srtti_typedescr.
    CALL TRANSFORMATION id
        SOURCE XML xstring
        RESULT srtti = srtti2.
